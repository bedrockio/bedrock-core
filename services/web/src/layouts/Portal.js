...
export default class PortalLayout extends React.Component {
  render() {
    return (
      <Sidebar>
        <Layout style={{ background: '#f4f0eb', position: 'fixed', width: '100%', zIndex:'1' }}>
          <Layout horizontal spread center style={{ padding: '20px 25px 10px 25px' }}>
            <NavLink className="logo" to="/">
              <img style={{ height: '30px' }} src={logo} />
            </NavLink>
            <div>
            <NavLink to="/signup" style={{ marginRight:'20px', fontWeight: 'bold' }}>
              Create Account
            </NavLink>
